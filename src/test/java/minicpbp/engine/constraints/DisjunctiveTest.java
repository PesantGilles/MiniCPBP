...
public class DisjunctiveTest extends SolverTest {
    ...
    public void testAllDiffDisjunctive() {
        ...
        try {
            ...
            cp.post(new Disjunctive(s, d),true);
    ...
    public void testBinaryDecomposition() {
        ...
        try {
            cp.post(new Disjunctive(new IntVar[]{s1, s2}, new int[]{d1, d2}),true);
    ...
    public void testOverloadChecker() {
        ...
        try {
            cp.post(new Disjunctive(new IntVar[]{sA, sB, sC}, new int[]{d1, d2, d3}),true);
            assert (false);
